...
This was not very concealed and could have been noticed by Price.


\subsection{Proving with \texttt{wireshark} that the proxy is working}
To prove that Price's machine was using the proxy on the attack machine correctly, I used \texttt{wireshark} to monitor the network. I have included a screenshot in Appendix~[x] and a link to the \texttt{capture1.pcapng} file in Appendix~[x].
...
\begin{figure}[h!]
% \includegraphics[height=\textwidth, angle=-90]{It's_Elementary_my_dear_Watson!-2017-12-06-13-41-10}
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-06-13-41-10}
\end{figure}
\pagebreak
\section{Connecting to Price's account with \texttt{ssh}}
\label{app:screenshots:2}
\begin{figure}[h!]
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-19-15-19-29}
\end{figure}
\pagebreak
\section{Copying the \texttt{auth.log} with \texttt{scp}}
\label{app:screenshots:3}
\begin{figure}[h!]
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-19-15-59-43}
\end{figure}
\pagebreak
\section{Connecting to the new \textit{'systemd-usertest'} account with \texttt{ssh}}
\label{app:screenshots:4}
\begin{figure}[h!]
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-19-20-19-08}
\end{figure}
\pagebreak
\section{\texttt{ip a} on the attack machine}
\label{app:screenshots:5}
\begin{figure}[h!]
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-20-16-17-08}
\end{figure}
\pagebreak
\section{\texttt{ip a} on Price's machine}
\label{app:screenshots:6}
\begin{figure}[h!]
\includegraphics[width=\textwidth]{It's_Elementary_my_dear_Watson!-2017-12-20-16-17-51}
\end{figure}
