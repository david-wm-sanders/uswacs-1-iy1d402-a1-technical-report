...
The full code listing for the script can be found in Appendix~\ref{app:code}.
...
\lstinputlisting[language=Python, frame=single, showstringspaces=false]{code/sshcrack_mp.py}
